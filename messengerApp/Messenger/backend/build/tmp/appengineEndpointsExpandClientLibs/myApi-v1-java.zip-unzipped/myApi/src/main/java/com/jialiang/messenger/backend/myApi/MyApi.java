...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Getmessages getmessages(java.lang.String username, java.lang.String password, java.lang.String friend) throws java.io.IOException {
    Getmessages result = new Getmessages(username, password, friend);
    initialize(result);
    return result;
  }

  public class Getmessages extends MyApiRequest<com.jialiang.messenger.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "mybean/{username}/{password}/{friend}";
     ...
     * @since 1.13
     */
    protected Getmessages(java.lang.String username, java.lang.String password, java.lang.String friend) {
      super(MyApi.this, "GET", REST_PATH, null, com.jialiang.messenger.backend.myApi.model.MyBean.class);
      this.username = com.google.api.client.util.Preconditions.checkNotNull(username, "Required parameter username must be specified.");
      this.password = com.google.api.client.util.Preconditions.checkNotNull(password, "Required parameter password must be specified.");
    ...
    public Getmessages setUsername(java.lang.String username) {
      this.username = username;
      return this;
    }
    ...
    public Getmessages setPassword(java.lang.String password) {
      this.password = password;
      return this;
    }
    ...
    public Getmessages setFriend(java.lang.String friend) {
      this.friend = friend;
      return this;
    }
  ...
  /**
   * Create a request for the method "unreadcount".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link Unreadcount#execute()} method to invoke the remote operation.
   *
   * @param username
   * @param password
   * @return the request
   */
  public Unreadcount unreadcount(java.lang.String username, java.lang.String password) throws java.io.IOException {
    Unreadcount result = new Unreadcount(username, password);
    initialize(result);
    return result;
  }

  public class Unreadcount extends MyApiRequest<com.jialiang.messenger.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "unreadCount/{username}/{password}";

    /**
     * Create a request for the method "unreadcount".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link Unreadcount#execute()} method to invoke the remote operation. <p>
     * {@link
     * Unreadcount#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param username
     * @param password
     * @since 1.13
     */
    protected Unreadcount(java.lang.String username, java.lang.String password) {
      super(MyApi.this, "POST", REST_PATH, null, com.jialiang.messenger.backend.myApi.model.MyBean.class);
      this.username = com.google.api.client.util.Preconditions.checkNotNull(username, "Required parameter username must be specified.");
      this.password = com.google.api.client.util.Preconditions.checkNotNull(password, "Required parameter password must be specified.");
    }
    ...
    @Override
    public Unreadcount setAlt(java.lang.String alt) {
      return (Unreadcount) super.setAlt(alt);
    }

    @Override
    public Unreadcount setFields(java.lang.String fields) {
      return (Unreadcount) super.setFields(fields);
    }

    @Override
    public Unreadcount setKey(java.lang.String key) {
      return (Unreadcount) super.setKey(key);
    }

    @Override
    public Unreadcount setOauthToken(java.lang.String oauthToken) {
      return (Unreadcount) super.setOauthToken(oauthToken);
    }

    @Override
    public Unreadcount setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (Unreadcount) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public Unreadcount setQuotaUser(java.lang.String quotaUser) {
      return (Unreadcount) super.setQuotaUser(quotaUser);
    }

    @Override
    public Unreadcount setUserIp(java.lang.String userIp) {
      return (Unreadcount) super.setUserIp(userIp);
    }
    ...
    public Unreadcount setUsername(java.lang.String username) {
      this.username = username;
      return this;
    }
    ...
    public Unreadcount setPassword(java.lang.String password) {
      this.password = password;
      return this;
    }

    @Override
    public Unreadcount set(String parameterName, Object value) {
      return (Unreadcount) super.set(parameterName, value);
    }
  }
